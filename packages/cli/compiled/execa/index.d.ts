...
import { type Readable as ReadableStream, type Stream, type Writable as WritableStream } from 'node:stream';
...
```
*/
export function execa(file: string, arguments?: readonly string[], options?: Options): ExecaChildProcess;
export function execa(file: string, arguments?: readonly string[], options?: Options<null>): ExecaChildProcess<Buffer>;
...
```
*/
export function execaSync(file: string, arguments?: readonly string[], options?: SyncOptions): ExecaSyncReturnValue;
...
export function execaSync(file: string, options?: SyncOptions<null>): ExecaSyncReturnValue<Buffer>;
...
type Execa$<StdoutStderrType extends StdoutStderrAll = string> = {
  ...
  (templates: TemplateStringsArray, ...expressions: TemplateExpression[]): ExecaChildProcess<StdoutStderrType>;
  ...
  /**
	...
	```
	*/
  sync(templates: TemplateStringsArray, ...expressions: TemplateExpression[]): ExecaSyncReturnValue<StdoutStderrType>;
};
...
```
*/
export function execaNode(scriptPath: string, arguments?: readonly string[], options?: NodeOptions): ExecaChildProcess;
