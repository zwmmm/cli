...
import { BackgroundColorName, ColorName, ForegroundColorName, ModifierName } from './vendor/ansi-styles/index.js';
...
export { ColorInfo, ColorSupport, ColorSupportLevel } from './vendor/supports-color/index.js';
